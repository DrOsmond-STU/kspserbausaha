...
export const MENU = [
  {
    judul: 'Ikhtisar',
    item: [
      { rute: '/', nama: 'Dasbor Eksekutif', ikon: '📊', izin: 'dashboard.view' },
      { rute: '/bi', nama: 'Business Intelligence', ikon: '📈', izin: 'bi.view' },
      { rute: '/portal', nama: 'Portal Anggota', ikon: '📱', izin: 'portal.view' },
    ],
  },
  {
    judul: 'Keanggotaan & Simpan Pinjam',
    item: [
      { rute: '/anggota', nama: 'Keanggotaan', ikon: '👥', izin: 'anggota.view' },
      { rute: '/simpanan', nama: 'Simpanan', ikon: '🏦', izin: 'simpanan.view' },
      { rute: '/pinjaman', nama: 'Pinjaman', ikon: '💳', izin: 'pinjaman.view' },
      { rute: '/shu', nama: 'SHU', ikon: '🧮', izin: 'shu.view' },
    ],
  },
  {
    judul: 'Usaha & Perdagangan',
    item: [
      { rute: '/pos', nama: 'Kasir Toko (POS)', ikon: '🛒', izin: 'pos.view' },
      { rute: '/persediaan', nama: 'Persediaan', ikon: '📦', izin: 'persediaan.view' },
      { rute: '/pembelian', nama: 'Pembelian', ikon: '🚚', izin: 'pembelian.view' },
      { rute: '/penjualan', nama: 'Penjualan', ikon: '🧾', izin: 'penjualan.view' },
      { rute: '/unit-usaha', nama: 'Unit Usaha', ikon: '🏢', izin: 'unit.view' },
    ],
  },
  {
    judul: 'Keuangan',
    item: [
      { rute: '/akuntansi', nama: 'Akuntansi', ikon: '📒', izin: 'akuntansi.view' },
      { rute: '/laporan', nama: 'Laporan Keuangan', ikon: '📑', izin: 'laporan.view' },
      { rute: '/kas', nama: 'Kas & Bank', ikon: '💰', izin: 'kas.view' },
      { rute: '/anggaran', nama: 'Anggaran (RKAP)', ikon: '🎯', izin: 'anggaran.view' },
      { rute: '/aset', nama: 'Aset Tetap', ikon: '🏗️', izin: 'aset.view' },
    ],
  },
  {
    judul: 'Organisasi & Tata Kelola',
    item: [
      { rute: '/rat', nama: 'RAT', ikon: '🗳️', izin: 'rat.view' },
      { rute: '/approval', nama: 'Persetujuan', ikon: '✅', izin: 'approval.view' },
      { rute: '/dokumen', nama: 'Dokumen & Surat', ikon: '🗂️', izin: 'dokumen.view' },
      { rute: '/compliance', nama: 'Kepatuhan', ikon: '⚖️', izin: 'compliance.view' },
      { rute: '/audit', nama: 'Audit Internal', ikon: '🔍', izin: 'audit.view' },
      { rute: '/risiko', nama: 'Manajemen Risiko', ikon: '⚠️', izin: 'risiko.view' },
      { rute: '/crm', nama: 'CRM Anggota', ikon: '💬', izin: 'crm.view' },
    ],
  },
  {
    judul: 'Sistem',
    item: [
      { rute: '/master', nama: 'Master Data', ikon: '🗄️', izin: 'master.view' },
      { rute: '/admin', nama: 'Administrator', ikon: '⚙️', izin: 'admin.view' },
    ],
  },
];
